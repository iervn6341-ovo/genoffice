...
const api: SlidesApi = {
  ...
  getNotesRich: (slideIndex: number) => ipcRenderer.invoke('slides:get-notes-rich', slideIndex),
  ...
  displayCount: () => ipcRenderer.invoke('slides:display-count'),
  presenterStart: (opts?: { monitor?: string | null }) =>
    ipcRenderer.invoke('slides:presenter-start', opts),
  displayList: () => ipcRenderer.invoke('slides:display-list'),
  audienceInk: (ev: ShowInkEvent) => ipcRenderer.send('slides:audience-ink', ev),
