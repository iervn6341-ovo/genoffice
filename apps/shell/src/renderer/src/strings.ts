...
export const strings = {
  zh: {
    ...
    aiPanelSideRight: '右侧',
    setRibbonFold: '功能区布局',
    ribbonFoldClassic: '默认（折叠工具）',
    ribbonFoldAuto: '自动调整（根据窗口宽度调整）',
  ...
  en: {
    ...
    setRibbonFold: 'Ribbon layout',
    ribbonFoldClassic: 'Default (collapsed tools)',
    ribbonFoldAuto: 'Auto-adjust (fits the window width)',
  ...
  ja: {
    ...
    aiPanelSideLeft: '左側',
    aiPanelSideRight: '右側',
    setRibbonFold: 'リボンのレイアウト',
    ribbonFoldClassic: '既定（折りたたみツール）',
    ribbonFoldAuto: '自動調整（ウィンドウ幅に応じて調整）',
  ...
  ko: {
    ...
    setRibbonFold: '리본 레이아웃',
    ribbonFoldClassic: '기본(접힌 도구)',
    ribbonFoldAuto: '자동 조정(창 너비에 맞춤)',
  ...
  fr: {
    ...
    setRibbonFold: 'Disposition du ruban',
    ribbonFoldClassic: 'Par défaut (outils repliés)',
    ribbonFoldAuto: 'Ajustement auto (selon la largeur de la fenêtre)',
  ...
  de: {
    ...
    setRibbonFold: 'Menüband-Layout',
    ribbonFoldClassic: 'Standard (eingeklappte Werkzeuge)',
    ribbonFoldAuto: 'Automatisch anpassen (nach Fensterbreite)',
  ...
  es: {
    ...
    setRibbonFold: 'Diseño de la cinta',
    ribbonFoldClassic: 'Predeterminado (herramientas contraídas)',
    ribbonFoldAuto: 'Ajuste automático (según el ancho de la ventana)',
  ...
  th: {
    ...
    setRibbonFold: 'เลย์เอาต์ริบบิน',
    ribbonFoldClassic: 'ค่าเริ่มต้น (เครื่องมือแบบพับ)',
    ribbonFoldAuto: 'ปรับอัตโนมัติ (ตามความกว้างหน้าต่าง)',
  ...
  id: {
    ...
    setRibbonFold: 'Tata letak pita',
    ribbonFoldClassic: 'Default (alat diciutkan)',
    ribbonFoldAuto: 'Sesuai otomatis (menurut lebar jendela)',
  ...
  ru: {
    ...
    setRibbonFold: 'Макет ленты',
    ribbonFoldClassic: 'По умолчанию (свёрнутые инструменты)',
    ribbonFoldAuto: 'Автоподбор (по ширине окна)',
  ...
  ar: {
    ...
    setRibbonFold: 'تخطيط الشريط',
    ribbonFoldClassic: 'الافتراضي (أدوات مطوية)',
    ribbonFoldAuto: 'ضبط تلقائي (حسب عرض النافذة)',
  ...
  pt: {
    ...
    setRibbonFold: 'Layout da faixa',
    ribbonFoldClassic: 'Padrão (ferramentas recolhidas)',
    ribbonFoldAuto: 'Ajuste automático (conforme a largura da janela)',
  ...
  it: {
    ...
    setRibbonFold: 'Layout della barra multifunzione',
    ribbonFoldClassic: 'Predefinito (strumenti compressi)',
    ribbonFoldAuto: 'Regolazione automatica (in base alla larghezza della finestra)',
  ...
  pl: {
    ...
    setRibbonFold: 'Układ wstążki',
    ribbonFoldClassic: 'Domyślnie (zwinięte narzędzia)',
    ribbonFoldAuto: 'Automatyczne dopasowanie (do szerokości okna)',
  ...
  cs: {
    ...
    setRibbonFold: 'Rozložení pásu karet',
    ribbonFoldClassic: 'Výchozí (sbalené nástroje)',
    ribbonFoldAuto: 'Automatické přizpůsobení (podle šířky okna)',
  ...
  nl: {
    ...
    aiPanelSideLeft: 'Links',
    aiPanelSideRight: 'Rechts',
    setRibbonFold: 'Lintindeling',
    ribbonFoldClassic: 'Standaard (samengevouwen hulpmiddelen)',
    ribbonFoldAuto: 'Automatisch aanpassen (op vensterbreedte)',
  ...
  ms: {
    ...
    aiPanelSideLeft: 'Kiri',
    aiPanelSideRight: 'Kanan',
    setRibbonFold: 'Susun atur riben',
    ribbonFoldClassic: 'Lalai (alat dilipat)',
    ribbonFoldAuto: 'Laras automatik (mengikut lebar tetingkap)',
  ...
  he: {
    ...
    setRibbonFold: 'פריסת הסרט',
    ribbonFoldClassic: 'ברירת מחדל (כלים מכווצים)',
    ribbonFoldAuto: 'התאמה אוטומטית (לפי רוחב החלון)',
  ...
  hi: {
    ...
    setRibbonFold: 'रिबन लेआउट',
    ribbonFoldClassic: 'डिफ़ॉल्ट (समेटे हुए टूल)',
    ribbonFoldAuto: 'स्वतः समायोजन (विंडो की चौड़ाई के अनुसार)',
  ...
  'zh-TW': {
    ...
    aiPanelSideLeft: '左側',
    aiPanelSideRight: '右側',
    setRibbonFold: '功能區版面配置',
    ribbonFoldClassic: '預設（收合工具）',
    ribbonFoldAuto: '自動調整（根據視窗寬度進行調整）',
    setAiFontSize: 'AI 面板文字大小',
